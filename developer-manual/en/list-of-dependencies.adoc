...
** https://xiph.org/ogg/[libogg]
** https://openal-soft.org/[OpenAL-Soft]

* Graphics and GUI libraries
** https://www.opengl.org/[OpenGL] >= 1.3 **_optional_** for OpenGL support
** http://glew.sourceforge.net/[GLEW]
** https://github.com/fifengine/fifechan[FifeChan] >= 0.1.0 **_optional_**

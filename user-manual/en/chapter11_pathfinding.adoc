...
[horizontal]
*ROUTE_CREATED*:: (0) Route created but not yet calculated
*ROUTE_SEARCHING*:: (1) Path calculation in progress
*ROUTE_SEARCHED*:: (2) Search complete, ready to solve
*ROUTE_SOLVED*:: (3) Path found successfully
*ROUTE_FAILED*:: (4) No path could be found

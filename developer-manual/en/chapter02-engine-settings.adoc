...
TIP: For runtime configuration in game code, see the https://fifengine.github.io/fifengine-docs/user-manual/en/#_runtime_configuration[User Manual - Runtime Configuration].
